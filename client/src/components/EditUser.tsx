...
import { FieldError, SubmitHandler, UseFormRegister, useForm } from "react-hook-form";
...
function EditUser({_id, firstName
 , setFirstName,lastName,setLastName,middleName,setMiddleName,
email,setEmail,phone,setPhone,imageAlt,setImageAlt,country,setCountry,city,setCity,
street,setStreet,houseNumber,setHouseNumber,zip,setZip,isBusiness,setIsBusiness,onCloseModal
}: Props) {
...
user.isBusiness = isBusiness;
 ...
 editUserFunction(_id, user).then((res) => {
    }).catch(error => {

            console.error("Error editing user:", error);
        });
}
    return (   <Container component="main" maxWidth="md" sx={{ mt: 4, mb: 4 }}>
              <CssBaseline />
             <FormLayout>  <form noValidate onSubmit={handleSubmit(onSubmit)}>
            ...
            <Grid container direction="column" justifyContent="center" alignItems="center" className='mt-4'>
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  autoFocus
                  value={firstName}  
                  style={{ width: '100%', marginBottom: '1rem', fontSize: '1.2rem' }}
              ...
              <Grid item xs={12} sm={12}>
                <FormControlLabel
                  control={<Checkbox checked={isBusiness} onChange={handleCheckChange} color="primary" />}
